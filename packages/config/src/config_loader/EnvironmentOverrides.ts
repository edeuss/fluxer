...
const NAMED_FLUXER_ENV_OVERRIDES: Record<string, NamedEnvOverride> = {
	...
	FLUXER_AUTH_TRAKT_ENABLED: {path: ['auth', 'trakt', 'enabled'], parse: parseEnvValue},
	FLUXER_AUTH_TRAKT_CLIENT_ID: {path: ['auth', 'trakt', 'client_id']},
	FLUXER_AUTH_TRAKT_CLIENT_SECRET: {path: ['auth', 'trakt', 'client_secret']},
