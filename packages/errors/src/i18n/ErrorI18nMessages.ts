...
export const ERROR_I18N_MESSAGES = {
	...
	'connections.trakt_oauth_authorization_failed': "We couldn't start the Trakt authorisation flow. Please try again.",
	'connections.trakt_oauth_callback_failed': "We couldn't complete the Trakt connection. Please try again.",
	'connections.trakt_oauth_not_enabled': 'Trakt connections are not enabled on this instance.',
	'connections.trakt_oauth_session_expired': 'Your Trakt session has expired. Please reconnect your account.',
	'connections.trakt_oauth_state_invalid': 'The authorization request has expired or is invalid. Please try again.',
