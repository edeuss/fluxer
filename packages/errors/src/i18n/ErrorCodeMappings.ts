...
export const ErrorCodeToI18nKey = {
	...
	[APIErrorCodes.TRAKT_OAUTH_AUTHORIZATION_FAILED]: 'connections.trakt_oauth_authorization_failed',
	[APIErrorCodes.TRAKT_OAUTH_CALLBACK_FAILED]: 'connections.trakt_oauth_callback_failed',
	[APIErrorCodes.TRAKT_OAUTH_NOT_ENABLED]: 'connections.trakt_oauth_not_enabled',
	[APIErrorCodes.TRAKT_OAUTH_SESSION_EXPIRED]: 'connections.trakt_oauth_session_expired',
	[APIErrorCodes.TRAKT_OAUTH_STATE_INVALID]: 'connections.trakt_oauth_state_invalid',
